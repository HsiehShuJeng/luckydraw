<template>
    <div id="SettingBox" ref="box" class="modal" tabindex="-1" role="dialog" data-backdrop="static"
        data-keyboard="false">
            ...
            <div class="modal-content">
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <input v-model="input.webTitle" type="text" class="form-control" name="webTitle"
                                placeholder="LuckyDraw" autocomplete="off">
                        </div>
                        <div class="form-group">
                            ...
                            <input v-model="input.headerColor" type="text" class="form-control" name="headerColor"
                                autocomplete="off">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                <input v-model="input.backgroundImg" type="text" class="form-control"
                                    name="backgroundImg" placeholder="請輸入圖片網址" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <input v-model.number="input.backgroundOpacity" type="number" class="form-control"
                                name="backgroundOpacity" min="0" max="1" step="0.1" autocomplete="off">
                        </div>
                        ...
                        <div class="box-setting" rel="boxSize">
                            <div class="form-group">
                                ...
                                <input v-model.number="input.boxWidth" type="range" class="form-control" min="100"
                                    max="200" name="boxWidth">
                            </div>
                            <div class="form-group">
                                <label for="boxHeight">區塊高度 [{{ input.boxHeight }} px]</label>
                                <input v-model.number="input.boxHeight" type="range" class="form-control" min="50"
                                    max="100" name="boxHeight">
                            </div>
                            <div class="form-group">
                                <label for="boxMH">區塊左右間距 [{{ input.boxMH }} px]</label>
                                <input v-model.number="input.boxMH" type="range" class="form-control" min="1" max="30"
                                    name="boxMH">
                            </div>
                            <div class="form-group">
                                <label for="boxMV">區塊上下間距 [{{ input.boxMV }} px]</label>
                                <input v-model.number="input.boxMV" type="range" class="form-control" min="1" max="30"
                                    name="boxMV">
                            </div>
                        </div>
                        ...
                        <div class="box-setting" rel="boxColor">
                            <div class="form-group">
                                ...
                                <input v-model="input.defaultColor" type="text" class="form-control" name="defaultColor"
                                    autocomplete="off">
                            </div>
                            <div class="form-group">
                                ...
                                <input v-model="input.focusColor" type="text" class="form-control" name="focusColor">
                            </div>
                            <div class="form-group">
                                ...
                                <input v-model="input.doneColor" type="text" class="form-control" name="doneColor">
                            </div>
                        </div>
                        <hr />
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <div class="col-6 text-left">
                        <button type="button" class="btn btn-danger clearAllBtn" @click="clear">
                            清除所有資料
                        </button>
                    </div>
